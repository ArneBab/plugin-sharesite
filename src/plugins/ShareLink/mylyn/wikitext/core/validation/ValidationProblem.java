 ...
 *******************************************************************************/
package plugins.ShareWiki.mylyn.wikitext.core.validation;
...
public class ValidationProblem implements Comparable<ValidationProblem> {
	 ...
	 */
	public static final String DEFAULT_MARKER_ID = "plugins.ShareWiki.mylyn.wikitext.core.validation.problem";//$NON-NLS-1$
